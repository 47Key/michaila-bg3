    ...
    return (
        <section className="w-screen">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
                ...
                <h3 className="text-xl text-gray-200 lg:px-48">Embark on an Epic Journey with Fellow Adventurers.</h3>
                <p className="text-sm text-gray-400 lg:px-48">Join our vibrant community of gamers dedicated to exploring the rich, fantastical world of Baldur's Gate 3. Discover, strategize, and conquer together.</p>
                <div className="mt-8 lg:mt-16 mb-8 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                    <div className='py-2.5'>
                        ...
                        <p className="mx-5 mb-4 text-gray-400">Engage in discussions, share your character builds, and explore the vast possibilities within the game. Our server is the perfect place to enhance your gaming experience.</p>
                    </div>
                    <div className='py-2.5'>
                        ...
                        <p className="mx-5 mb-4 text-gray-400">Access to custom events, tips from veteran players, and the latest news about Baldur's Gate 3. Stay ahead in your adventure with our expert insights.</p>
                    </div>
                    <div className='py-2.5'>
                        ...
                        <p class="mb-4 text-gray-400">Dive into regular in-game events and team-based challenges. Collaborate with fellow discord members in epic quests and enjoy exclusive multiplayer adventures tailored for our community.</p>
                    </div>
                </div>
            </div>
        </section>
