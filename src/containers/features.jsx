            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
                ...
                <div className="mt-8 lg:mt-16 mb-8 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                    ...
                    <div className='py-2.5'>
                        ...
                        <p class="mx-5 mb-4 text-white">Dive into regular in-game events and team-based challenges. Collaborate with fellow discord members in epic quests and enjoy exclusive multiplayer adventures tailored for our community.</p>
                    </div>
                    <div className='py-2.5'>
